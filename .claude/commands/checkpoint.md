...
## How to test it
Exact commands only (start app, run tests, verify APIs/UI + expected output). Only commands that exist in the project.

## Risks or follow-up
Technical debt, temporary implementations, missing tests, future refactoring opportunities.

Keep the entire response under 60 lines.
